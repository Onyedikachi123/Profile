	...
	gullFoss = {
		...
		imageSlider: function() {
			...
			$('#imageSlideActive').slick({
				...
				prevArrow:
					'<button class="prev-arrow"><i class="fas fa-angle-up"></i></button>',
				nextArrow:
					'<button class="next-arrow"><i class="fas fa-angle-down"></i></button>',
				dots: true,
		...
		testimonial() {
			...
			$('#testimonialActive').slick({
				...
				arrows: true,
				prevArrow:
					'<button class="prev-arrow"><img src="assets/img/icon/angle-right01.png"></button>',
				nextArrow:
					'<button class="next-arrow"><img src="assets/img/icon/angle-left.png"></button>',
				dots: true,
